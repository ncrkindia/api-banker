 ...
 *
 * <p>
 * Represents the primary hierarchical entity in the ApiBanker workspace.
 * A Collection acts as a folder/container that groups multiple
 * {@link RequestModel}s,
 * sub-folders (other CollectionModels), and scoped variables. It also defines
 * inheritable configurations like SSL verification rules, HTTP redirect
 * settings,
...
public class CollectionModel {
    ...
    /**
     * @return The list of direct child {@link RequestModel}s belonging to this
     *         collection/folder.
     */
    ...
    /**
     * @return The Authorization strategy (none, bearer, basic, apiKey) applied to
     *         child requests.
     */
    ...
    /**
     * @return The raw JavaScript block to execute before any child request is
     *         fired.
     */
    ...
    /**
     * @return The raw JavaScript block to execute after any child request
     *         completes.
     */
    ...
    public void setFolders(List<CollectionModel> folders) {
        this.folders = folders;
    }

    /**
     * @return The SSL Verification strategy (INHERIT, VERIFY, NO_VERIFY). Defaults
     *         to INHERIT.
     */
