...
public class JwtDecoderPanel extends JPanel {
    ...
    private void decode() {
        ...
        try {
            ...
            if (parts.length < 2) {
                JOptionPane.showMessageDialog(this, "Invalid JWT format. Expected 3 parts separated by '.'",
                        "Invalid JWT", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            JOptionPane.showMessageDialog(this, "Error decoding: " + e.getMessage(), "Decode Error",
