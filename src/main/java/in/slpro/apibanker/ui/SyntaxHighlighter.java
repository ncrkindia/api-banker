...
public class SyntaxHighlighter {
    public static String highlightJson(String json) {
        ...
        StringBuffer sb = new StringBuffer(
                "<html><body style='font-family:\"JetBrains Mono\",\"Courier New\",monospace; font-size:11px; margin:5px;'>");
            ...
            if (strLiteral != null) {
                if (colon != null) {
                    matcher.appendReplacement(sb,
                            "<span style='color:#2980b9; font-weight:bold;'>" + strLiteral + "</span>" + colon);
                } else {
                    matcher.appendReplacement(sb, "<span style='color:#27ae60;'>" + strLiteral + "</span>");
                }
            } else if (primitive != null) {
                String color = "null".equals(primitive) ? "#7f8c8d"
                        : (primitive.equals("true") || primitive.equals("false") ? "#8e44ad" : "#d35400");
                matcher.appendReplacement(sb,
                        "<span style='color:" + color + "; font-weight:bold;'>" + primitive + "</span>");
            } else if (structural != null) {
                matcher.appendReplacement(sb,
                        "<span style='color:#2c3e50; font-weight:bold;'>" + structural + "</span>");
            }
        }
