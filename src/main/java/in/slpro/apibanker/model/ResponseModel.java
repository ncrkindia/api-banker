...
public class ResponseModel {
    ...
    public List<ResponseModel> getRedirects() {
        return redirects;
    }

    public void setRedirects(List<ResponseModel> redirects) {
    ...
    public long getPreRequestTimeMs() {
        return preRequestTimeMs;
    }

    public void setPreRequestTimeMs(long preRequestTimeMs) {
        this.preRequestTimeMs = preRequestTimeMs;
    }
    ...
    public long getTestScriptTimeMs() {
        return testScriptTimeMs;
    }

    public void setTestScriptTimeMs(long testScriptTimeMs) {
        this.testScriptTimeMs = testScriptTimeMs;
    }
}
