...
public class GlobalVariablesPanel extends JPanel {
    ...
    public void loadModel() {
        if (globalsTableModel == null) return;
    ...
    public static void setupTableCopyPaste(JTable table, DefaultTableModel model) {
        ...
        table.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT)
             .put(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Z, java.awt.event.InputEvent.CTRL_DOWN_MASK), "undo");
        ...
        table.getInputMap(JComponent.WHEN_FOCUSED).put(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_DELETE, 0), "deleteRow");
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    undoManager.addEdit(new javax.swing.undo.AbstractUndoableEdit() {
                        ...
                        public void redo() {
                            super.redo();
                            // Simplified redo just says sorry, can't easily redo paste without saving all data again
