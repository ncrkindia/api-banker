...
public class CookieJarPanel extends JPanel {
    ...
    public CookieJarPanel(MainFrame mainFrame) {
        ...
        JLabel titleLabel = new JLabel("<html><b>Cookie Jar Manager</b><br/><font color='#7f8c8d'>Manage captured or manual cookies. These cookies will be attached to outgoing requests matching their domain and path.</font></html>");
        ...
        scrollPane.setBorder(BorderFactory.createMatteBorder(1, 0, 1, 0, UIManager.getColor("Separator.foreground") != null ? UIManager.getColor("Separator.foreground") : new Color(220, 220, 220)));
    ...
    private void showAddEditDialog(CookieModel existing) {
        ...
        JDialog dialog = new JDialog(parentWindow, existing == null ? "Add Cookie" : "Edit Cookie", Dialog.ModalityType.APPLICATION_MODAL);
