...
public class CollectionRunnerPanel extends JPanel {
    ...
    private void exportExcel(File file) throws Exception {
        ...
        titleCell.setCellValue("JAPI PERFORMANCE RUNNER REPORT");
        ...
        r6.createCell(1).setCellValue("SLPRO Japi Studio (from SL Pro)");
    ...
    private void exportHTML(File file) throws Exception {
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(file, StandardCharsets.UTF_8))) {
            ...
            pw.println(
                    "<div style='text-align:center; font-size:12px; color:#888; margin-top:30px; padding-top:15px; border-top:1px solid #eee;'>Confidential - Generated by JAPI - from SL Pro</div>");
    ...
    private void exportCSV(File file) throws Exception {
        try (PrintWriter pw = new PrintWriter(new FileWriter(file, StandardCharsets.UTF_8))) {
            pw.println("\"JAPI Performance Runner Report - from SL Pro\"");
