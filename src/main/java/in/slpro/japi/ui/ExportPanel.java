...
public class ExportPanel extends JPanel {
    ...
    public ExportPanel(MainFrame mainFrame, String exportType) {
        ...
        String titleText = "japi".equals(exportType) ? "📤 Export Japi Files" : "📤 Export Postman Files";
        ...
        try {
            for (JCheckBox cb : colCheckboxes) {
                if (cb.isSelected()) {
                    ...
                    String suffix = "japi".equals(exportType) ? "_japi_collection" : "_postman_collection";
            ...
            for (JCheckBox cb : envCheckboxes) {
                if (cb.isSelected()) {
                    ...
                    String suffix = "japi".equals(exportType) ? "_japi_environment" : "_postman_environment";
                    ...
                    try (java.io.FileWriter fw = new java.io.FileWriter(envFile)) {
                        if ("japi".equals(exportType)) {
                            ...
                            if (env.getVariables() != null) {
                                for (in.slpro.japi.model.KeyValueItem kv : env.getVariables()) {
